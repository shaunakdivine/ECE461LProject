...
export const addAuthUser = (payload) => ({ type: PROJECT_ADD_AUTH_USER, payload });
...
export const openAddAuthUserModal = () => ({ type: PROJECT_OPEN_ADD_AUTH_USER_MODAL });
...
export const closeAddAuthUserModal = () => ({ type: PROJECT_CLOSE_ADD_AUTH_USER_MODAL });